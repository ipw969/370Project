...
//* This is the scene, if any that will be replaced. This is used if the scene to be saved is to replace another scene(when a scene is edited)*/  
    ...
    protected void runImplementation() {
        ...
        if (replacedSceneName != null) {
            ...
            database().addCommand("update t_scene set scn_sceneDescription = '" + sceneToSave.getDescription() + "' where scn_scenename = '" + replacedSceneName + "';");
            ...
            database().addCommand("update t_scene set scn_scenename = '" + sceneToSave.getName() + "' where scn_scenename = '" + replacedSceneName + "';");
